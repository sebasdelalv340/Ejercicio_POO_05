...
/**
 * Clase que representa un objeto Tiempo con atributos de hora, minuto y segundo.
 *
 * @property hora Hora del tiempo (rango permitido: 0 a 23).
 * @property minuto Minuto del tiempo (rango permitido: 0 a 59).
 * @property segundo Segundo del tiempo (rango permitido: 0 a 59).
 */
class Tiempo() {

    var hora: Int = 0
        set(value) {
            require(this.minuto in 0..23) {"La hora debe estar entre 0 y 23"}
            field = value
        }
    var minuto: Int = 0
        set(value) {
            require(this.minuto in 0..59) {"La hora debe estar entre 0 y 23"}
            field = value
        }

    var segundo: Int = 0
        set(value) {
            require(this.segundo in 0..59) {"Los minutos deben estar entre 0 y 59"}
            field = value
        }

    constructor(hora: Int): this() {
        this.hora = hora
    }

    constructor(hora: Int, minuto: Int): this() {
        this.hora = hora
        this.minuto = minuto
    }

    constructor(hora: Int, minuto: Int, segundo: Int): this() {
        this.hora = hora
        this.minuto = minuto
    ...
    /**
     * Sobrescribe el método toString para proporcionar una representación de cadena del objeto Tiempo.
     *
     * @return Cadena que describe la hora, minuto y segundo del tiempo.
     */
    override fun toString(): String {
        return "${this.hora}h ${this.minuto}m ${this.minuto}s"
    }
}
...
fun main() {
    ...
    var tiempo1 = Tiempo(readln().toInt())
